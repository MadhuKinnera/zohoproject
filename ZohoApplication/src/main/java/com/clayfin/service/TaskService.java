...
public interface TaskService {
	...
	List<Task> getAllTaskByStatusAndEmployeeId(Integer employeeId, String status)
			throws EmployeeException, TaskException;

	List<Task> getAllTaskByDateAndEmployeeId(Integer employeeId, LocalDate date)
			throws EmployeeException, TaskException;

	List<Task> getAllTaskByStatusAndManagerId(Integer managerId, String status) throws EmployeeException, TaskException;
